...
class NotifyPayment extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
        ...
        return $this->_decorateRowHtml($element, "<td class='label'>Notificaciones de Pago<div class='tooltip'><span class='help'><span></span></span><div class='tooltip-content'>Ingresa a tu Culqipanel en la sección de eventos, hacer clic a +Añadir. Se abrirá un popup, en donde deberás escoger order.status.changed y pegar la siguiente URL</div></div></td><td>" . $this->toHtml() . '<p class="note"><span>Si no iniciaste sesión con tu cuenta de CulqiPanel, tienes que configurar esta URL.</span></p></td><td></td>');
    }
