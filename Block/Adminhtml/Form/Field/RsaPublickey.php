...
class RsaPublickey extends \Magento\Config\Block\System\Config\Form\Field
{
    /**
     * Template path
     *
     * @var string
     */
    protected $_template = 'system/config/rsa_publickey.phtml';
    const CONFIG_PATH = 'payment/culqi/rsa_publickey';
